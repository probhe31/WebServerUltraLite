var staticLoader = require('./statics/static-loader');
var	serverCore = require('./core/server-core');
...
function HttpServerLite(options)
{
	...
	this.server = serverCore.createServer(serverOptions);
